...
> 自动同步到 `wiki/`，详见 [Wiki 索引](../wiki/index.md)

**已创建并可直接查看**：

实体节点：
- [Snapdragon 8 Elite Gen 5](../wiki/entities/soc/snapdragon-8-elite-gen5.md) — NPU +37% 等关键数据 + 待验证项
- [华为 Huawei](../wiki/entities/brand/huawei.md) — Mate 80 系列 + 麒麟 9030 + 鸿蒙 6
- [硅碳负极电池](../wiki/entities/tech/silicon-carbon-anode.md) — 硅含量 10%→16% 演进数据

主题节点：
- [2026 影像旗舰战](../wiki/topics/2026-flagship-imaging-war.md) — 三厂"品牌借光"营销分析
- [2026 折叠形态](../wiki/topics/foldable-2026.md) — 三星耐久 + Apple 液态金属
